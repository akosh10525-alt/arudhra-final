...
pages = convert_from_path(r"C:\Users\manoj\OneDrive\Desktop\arudhra\arudhra project\Radar precie.pdf", 300, poppler_path=POPPLER_PATH)
...
from langchain_community.llms import Ollama
llm = Ollama(model="phi", options={"num_ctx": 512})
...
def pdf_to_images(file_path, start_page, end_page,dpi=150):
    ...
    """
    images = convert_from_path(file_path, first_page=start_page, last_page=end_page, fmt='jpeg', dpi=150, poppler_path=POPPLER_PATH)
    return images
...
def generate_questions(extracted_text, question_counts, question_type):
    ...
    for ui_qtype, count in question_counts.items():
        ...
        prompt = (
            ...
            "}\n\n"
            "OUTPUT RULES:\n"
            "- Return EXACTLY " + str(count) + " items in the JSON array for the requested question type.\n"
